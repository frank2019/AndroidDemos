package colorful.time.android.smoothprogressbar;
...
public class TestSmoothProgressBarActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_smoothprogressbar);
